  ...
  function a(a) {
    ...
    for (var b = [], d = 0, e = this.data.length; e > d; d++) {
      ...
      f > 65536
        ...
        : b[0] = f, this.parsedData = this.parsedData.concat(b);
    }
    ...
    var c = {
      ...
      f = {
        ...
        getLostPoint: function (a) {
          ...
          for (var d = 0; b > d; d++) {
            for (var e = 0; b - 6 > e; e++) {
              a.isDark(d, e) && !a.isDark(d, e + 1) && a.isDark(d, e + 2) &&
                a.isDark(d, e + 3) && a.isDark(d, e + 4) &&
                !a.isDark(d, e + 5) && a.isDark(d, e + 6) && (c += 40);
            }
          }
          for (var e = 0; b > e; e++) {
            for (var d = 0; b - 6 > d; d++) {
              a.isDark(d, e) && !a.isDark(d + 1, e) && a.isDark(d + 2, e) &&
                a.isDark(d + 3, e) && a.isDark(d + 4, e) &&
                !a.isDark(d + 5, e) && a.isDark(d + 6, e) && (c += 40);
            }
          }
        ...
        if (this._android && this._android <= 2.1) {
          ...
          CanvasRenderingContext2D.prototype.drawImage = function (
            ...
            if ("nodeName" in a && /img/i.test(a.nodeName)) {
              for (var l = arguments.length - 1; l >= 1; l--) {arguments[l] =
                  arguments[l] * b;}
            } else {"undefined" == typeof j &&
                (arguments[1] *= b,
                  arguments[2] *= b,
                  arguments[3] *= b,
                  arguments[4] *= b);}
            ...
            for (var i = 0; d > i; i++) {
              g.push(
                '<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' +
                  e + "px;height:" + f + "px;background-color:" +
                  (a.isDark(h, i) ? b.colorDark : b.colorLight) + ';"></td>',
              );
            }
            g.push("</tr>");
          }
