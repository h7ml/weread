          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-600">
                基于 Fresh (Deno) 构建的现代化微信读书 Web 阅读平台，提供优质的在线阅读体验和高级 TTS 功能。
              </p>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium text-gray-900">h7ml</span>
                </div>
                <div className="flex items-center">
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <div className="flex items-center space-x-4 text-sm text-gray-500">
                ...
                <div className="flex items-center space-x-2">
                  <span className="bg-black text-white px-2 py-1 rounded text-xs">Deno</span>
                  <span className="bg-green-500 text-white px-2 py-1 rounded text-xs">Fresh</span>
                  <span className="bg-blue-500 text-white px-2 py-1 rounded text-xs">TypeScript</span>
                </div>
              </div>
            </div>
          </div>
