          ...
          if (window.QRCode && qrCodeRef.current) {
            ...
            const checkAndGenerate = (retries = 0) => {
              if (window.QRCode && qrCodeRef.current) {
                ...
                console.log(`Waiting for QRCode library... retry ${retries + 1}/10`);
                setTimeout(() => checkAndGenerate(retries + 1), 300);
              } else {
                console.warn('QRCode library not available, using backup solution');
                // 使用备用方案
                if (qrCodeRef.current) {
  ...
  return (
    <div className="w-full max-w-md">
      <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-8 shadow-2xl border border-white/20 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-pink-400/20 to-violet-600/20 rounded-full translate-y-12 -translate-x-12"></div>
            ...
            <div className="text-center transform transition-all duration-500 animate-slideUp">
              ...
              <button 
                onClick={() => {
                  ...
                  alert('Test button works! Current status: ' + loginStatus.value);
                }}
            ...
            <div className="text-center transform transition-all duration-500">
              <div className="mb-8">
                <div className="relative mx-auto w-20 h-20 mb-6">
                  ...
                  <div className="absolute inset-2 rounded-full bg-gradient-to-r from-blue-500/20 to-purple-600/20 backdrop-blur-sm"></div>
                </div>
                <h3 className="text-xl font-semibold text-white mb-2">正在连接微信读书</h3>
                <p className="text-blue-100/70 text-sm">{statusMessage.value || "正在初始化登录流程..."}</p>
              </div>
            </div>
          )}
              ...
              <div className="mb-8">
                ...
                <div className="relative mx-auto mb-6">
                  <div className="w-56 h-56 bg-white rounded-3xl p-4 shadow-2xl mx-auto relative overflow-hidden">
                    {/* 二维码装饰边框 */}
                    <div className="absolute inset-2 rounded-2xl border-2 border-gray-100"></div>
                    ...
                    >
                      <div className="relative">
                        ...
                        <div className="absolute inset-0 w-12 h-12 border-4 border-purple-300 border-b-transparent rounded-full animate-spin animation-delay-150"></div>
                      </div>
                    </div>
                  </div>
                  
                  {/* 扫码状态指示器 */}
                  <div className="absolute -bottom-2 -right-2 w-12 h-12 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full items-center justify-center shadow-lg border-4 border-white hidden" id="scan-indicator">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">请扫描二维码</h3>
          ...
          {loginStatus.value === "success" && (
            <div className="text-center transform transition-all duration-500">
              <div className="mb-8">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">登录成功！</h3>
                <p className="text-green-100 text-sm mb-2">欢迎，{userName.value}</p>
                <p className="text-blue-100/70 text-sm">正在跳转到书架...</p>
              </div>

              {/* 进度条 */}
              <div className="w-full bg-white/20 rounded-full h-2 mb-4 overflow-hidden">
                <div className="bg-gradient-to-r from-green-400 to-emerald-500 h-2 rounded-full animate-pulse w-full transition-all duration-2000"></div>
              </div>
            </div>
          )}
          ...
          {loginStatus.value === "failed" && (
            <div className="text-center transform transition-all duration-500">
              <div className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-white mb-3">登录失败</h3>
          ...
          {loginStatus.value === "expired" && (
            <div className="text-center transform transition-all duration-500">
              <div className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-white mb-3">二维码已过期</h3>
