        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                onClick={() => loadShelf(localStorage.getItem("weread_token"), currentPage.value, searchQuery.value)}
        ...
        <div className="mb-6 bg-white rounded-lg shadow p-4">
          ...
          {!loading.value && (
            <div className="mt-4 text-sm text-gray-600">
              ...
              {pagination.value.totalPages > 1 && ` | 第 ${pagination.value.page}/${pagination.value.totalPages} 页`}
            </div>
          )}
        </div>
              ...
              <div className="ml-3">
                ...
                <div className="mt-4">
                  <button
                    onClick={() => {
                      error.value = "";
                      loadShelf(localStorage.getItem("weread_token"), currentPage.value, searchQuery.value);
                    }}
        ...
        {!loading.value && !error.value && books.value.length === 0 && (
          <div className="text-center py-12 bg-white rounded-lg shadow">
            ...
            <p className="mt-2 text-sm text-gray-500">
              {searchQuery.value ? "尝试调整搜索条件" : "去微信读书添加一些书籍吧"}
            </p>
            {searchQuery.value && (
              <button
                onClick={() => {
                ...
                {books.value.map((book) => (
                  ...
                  >
                    ...
                    <div className="p-3">
                      ...
                      <p className="text-xs text-gray-500 truncate mt-1" title={book.author}>
                        {book.author}
                      </p>
                        ...
                        <div className="mt-2">
                          <div className="bg-gray-200 rounded-full h-1.5">
                            <div 
                              ...
                              style={{ width: `${Math.min(book.readProgress, 100)}%` }}
                            ></div>
                          </div>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <img 
                              ...
                              onError={(e) => {
                                e.currentTarget.src = 'data:image/svg+xml;base64,';
                              }}
                            />
                            <div className="ml-4">
              ...
              <div className="mt-6 bg-white rounded-lg shadow px-4 py-3">
                <div className="flex items-center justify-between">
                  <div className="text-sm text-gray-700">
                    显示第 {((pagination.value.page - 1) * pagination.value.pageSize) + 1} - {Math.min(pagination.value.page * pagination.value.pageSize, pagination.value.total)} 项，
                    共 {pagination.value.total} 项
                  </div>
                  <div className="flex items-center space-x-2">
                    <button
                      onClick={() => handlePageChange(pagination.value.page - 1)}
                    ...
                    <span className="text-sm text-gray-700">
                      第 {pagination.value.page} 页，共 {pagination.value.totalPages} 页
                    </span>
                    <button
                      onClick={() => handlePageChange(pagination.value.page + 1)}
