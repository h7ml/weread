                      ...
                      {bookInfo.value.price && (
                        <div className="bg-yellow-50 rounded-xl p-4">
                          <div className="flex items-center">
                            ...
                            <div>
                              <span className="text-yellow-600 text-sm font-medium block">价格</span>
                        ...
                        <div className="bg-yellow-50 rounded-xl p-4">
                          <div className="flex items-center">
                            ...
                            <div className="flex-1">
                              ...
                              {bookInfo.value.newRatingCount && (
                                <span className="text-gray-500 text-xs">
                                  {bookInfo.value.newRatingCount.toLocaleString()} 人评价
                                </span>
                              )}
                            </div>
                          </div>
                      ...
                      {bookInfo.value.format && (
                        <div className="bg-yellow-50 rounded-xl p-4">
                          <div className="flex items-center">
                            ...
                            <div>
                              <span className="text-yellow-600 text-sm font-medium block">格式</span>
                      ...
                      {bookInfo.value.updateTime && (
                        <div className="bg-yellow-50 rounded-xl p-4">
                          <div className="flex items-center">
                            ...
                            <div>
                              <span className="text-yellow-600 text-sm font-medium block">更新时间</span>
                      ...
                      {bookInfo.value.publisher && (
                        <div className="bg-yellow-50 rounded-xl p-4">
                          <div className="flex items-center">
                            ...
                            <div>
                              <span className="text-yellow-600 text-sm font-medium block">出版社</span>
                              <span className="text-gray-900 font-semibold">{bookInfo.value.publisher}</span>
                              {bookInfo.value.isbn && (
                                <div className="text-gray-500 text-xs mt-1">ISBN: {bookInfo.value.isbn}</div>
                              )}
                            </div>
                          </div>
                        </div>
                      ...
                      {bookInfo.value.chapterSize && (
                        <div className="bg-yellow-50 rounded-xl p-4">
                          <div className="flex items-center">
                            ...
                            <div>
                              <span className="text-yellow-600 text-sm font-medium block">章节</span>
                              <div className="flex items-center gap-2">
                                <span className="text-gray-900 font-semibold">共{bookInfo.value.chapterSize}章</span>
                              ...
                              {bookInfo.value.maxFreeChapter && (
                                <div className="text-gray-500 text-xs mt-1">
                                  前{bookInfo.value.maxFreeChapter}章免费试读
                                </div>
                              )}
                            </div>
                          </div>
